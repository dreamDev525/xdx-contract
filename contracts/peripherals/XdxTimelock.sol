...
contract XdxTimelock is IXdxTimelock {
  ...
  function setFundingRate(
    ...
    require(
      ...
      "XdxTimelock: invalid _fundingRateFactor"
    );
    require(
      _stableFundingRateFactor < MAX_FUNDING_RATE_FACTOR,
      "XdxTimelock: invalid _stableFundingRateFactor"
    );
  ...
  function setFees(
    ...
    require(
      ...
      "XdxTimelock: invalid _stableTaxBasisPoints"
    );
    require(
      _mintBurnFeeBasisPoints < MAX_FEE_BASIS_POINTS,
      "XdxTimelock: invalid _mintBurnFeeBasisPoints"
    );
    ...
    require(
      ...
      "XdxTimelock: invalid _stableSwapFeeBasisPoints"
    );
    require(
      _marginFeeBasisPoints < MAX_FEE_BASIS_POINTS,
      "XdxTimelock: invalid _marginFeeBasisPoints"
    );
  ...
  function setMaxStrictPriceDeviation(address _priceFeed, uint256 _maxStrictPriceDeviation)
    external
    onlyAdmin
  {
